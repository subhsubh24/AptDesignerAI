    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-8 pt-12 md:pt-24 pb-16">
          ...
          {/* Feature Grid */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-24 md:mt-32 animate-stagger-children">
            {[
              ...
              <div
                key={feature.title}
                className="group flex flex-col gap-4 p-6 rounded-2xl bg-card border transition-all duration-300 hover:shadow-warm-md hover:-translate-y-1 animate-fade-in-up"
              >
          ...
          <div id="how-it-works" className="mt-24 md:mt-36 scroll-mt-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-headline">Three steps to your dream space</h2>
          ...
          <div className="mt-24 md:mt-36">
            <div className="text-center mb-12">
              ...
              <h2 className="text-headline">See the transformation</h2>
              <p className="text-muted-foreground mt-3 max-w-md mx-auto">
          ...
          <div className="mt-24 md:mt-36 mb-12">
            <div className="max-w-3xl mx-auto rounded-3xl bg-gradient-to-br from-accent-warm/10 via-card to-secondary border p-10 md:p-14 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-headline mb-4">Ready to transform your space?</h2>
